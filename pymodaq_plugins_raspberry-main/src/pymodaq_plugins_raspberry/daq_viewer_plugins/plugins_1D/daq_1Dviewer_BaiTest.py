...
class DAQ_1DViewer_Sinus(DAQ_Viewer_base):
    ...
    params = comon_parameters+[
        {'title': 'Amplitude', 'name' : 'amplitude', 'type': 'int', 'defaultValue' : '1', 'minValue' : 0, 'maxValue' : '10' },
        {'title': 'Phase', 'name' : 'phase', 'type': 'int', 'defaultValue' : '0' , 'minValue' : 0, 'maxValue' : '360'},
        {'title': 'Frequency', 'name' : 'frequency', 'type': 'float', 'defaultValue' :'10', 'minValue' : 0,}
    ...
    """def ini_attributes(self, parent=None, params_state=None):
